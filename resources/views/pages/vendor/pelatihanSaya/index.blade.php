    ...
    <article class="">
        ...
        <div class="TABLE-WITHOUT-SEARCH-BAR" style="display:none">
            <z>
                ...
                <a href="{{url('/vendor/pelatihan_saya/create')}}" class="btn btn-blue btn-sm btn-add-data" style="font-weight:600;margin-bottom:5px">TambahData</a>
            </z>
        </div>
        ...
        <div class="TABLE">
            <div class="row  d-flex between mb-2">
                ...
                <div class="col-md-4 d-flex justify-content-end" style="display: flex; justify-content: flex-end; gap: 5px;">
                    ...
                    <a href="{{url('/vendor/pelatihan_saya/create')}}" class="btn btn-blue btn-sm btn-add-data" style="font-weight:600;margin-bottom:5px">
    ...
    <script>
        ...
        $(document).on('click', '#btn-delete', function () {
            ...
            __swalConfirmation(async (data) => {
                try {
                    ...
                    const res = await fetch(`{{ url('api/vendor/pelatihan_saya/delete') }}`, customPost({
                    ...
                    if (status) {
                        ...
                        setTimeout(function() {
                            window.location.href = `{{ url('/vendor/pelatihan_saya') }}`
        ...
        function DataTables(searchTerm, categoryId = undefined) {
            ...
            const ajaxConfig = {
                ...
                ajax: {
                    url: `{{ url('api/vendor/pelatihan_saya/data-table') }}`,
                    dataType: 'JSON',
                    type: 'POST',
                    data: {
