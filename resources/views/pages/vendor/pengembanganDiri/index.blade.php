...
@section('breadcumbSubtitle', 'Pengembangan List')
    ...
    <article class="">
        ...
        <div class="TABLE-WITHOUT-SEARCH-BAR" style="display:none">
            <z>
                ...
                <a href="{{url('/vendor/pengembangan_diri/create')}}" class="btn btn-blue btn-sm btn-add-data" style="font-weight:600;margin-bottom:5px">TambahData</a>
            </z>
        </div>
        ...
        <div class="TABLE">
            <div class="row  d-flex between mb-2">
                ...
                <div class="col-md-4 d-flex justify-content-end" style="display: flex; justify-content: flex-end; gap: 5px;">
                    ...
                    <a href="{{url('/vendor/pengembangan_diri/create')}}" class="btn btn-blue btn-sm btn-add-data" style="font-weight:600;margin-bottom:5px">
            ...
            <table class="table table-hover mb-0" id="data-table">
                <thead>
                    <tr>
                        ...
                        <th class="pt-0">Tanggal Pelaksanaan</th>
    ...
    <script>
        ...
        $(document).on('click', '#btn-delete', function () {
            ...
            __swalConfirmation(async (data) => {
                try {
                    ...
                    const res = await fetch(`{{ url('api/vendor/pengembangan_diri/delete') }}`, customPost({
                    ...
                    if (status) {
                        ...
                        setTimeout(function() {
                            window.location.href = `{{ url('/vendor/pengembangan_diri') }}`
        ...
        function DataTables(searchTerm = '', categoryId = undefined) {
            ...
            const ajaxConfig = {
                ...
                ajax: {
                    url: `{{ url('api/vendor/pengembangan_diri/data-table') }}`,
                    dataType: 'JSON',
                    type: 'POST',
                    data: {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        orderable: false,
                        render: function(data) {
                            const tanggalMulai = data.tanggal_mulai || ''; // Ambil tanggal mulai atau ''
                            const tanggalSelesai = data.tanggal_akhir || ''; // Ambil tanggal selesai atau '-'
                    ...
                    },
                    {
                        ...
                        orderable: false,
                        render: function(data) {
                            const jamMulai = data.jam_mulai || ''; // Ambil jam mulai atau '-'
                            const jamSelesai = data.jam_akhir || ''; // Ambil jam selesai atau '-'
