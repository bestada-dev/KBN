    ...
    <article class="">
        ...
        <div class="TABLE-WITHOUT-SEARCH-BAR" style="display:none">
            <z>
                ...
                <a href="{{url('/vendor/test/create')}}" class="btn btn-blue btn-sm btn-add-data" style="font-weight:600;margin-bottom:5px">TambahData</a>
            </z>
        </div>
        ...
        <div class="SEARCH">
            ...
            <div class="row w-100">
                ...
                <div class="col-md-3">
                    <div class="d-flex gap-3 itemscenter">
                        <div class="input-group">
                            <select name="pelatihan" id="pelatihan" class="form-control" onchange="searchByPelatihan(event)">
                ...
                <div class="col-md-3">
                    <div class="d-flex gap-3 itemscenter">
                        <select class="form-select" name="type_test" id="type_test" onchange="searchByTipe(event)">
        ...
        <div class="TABLE">
            <div class="row  d-flex between mb-2">
                ...
                <div class="col-md-4 d-flex justify-content-end" style="display: flex; justify-content: flex-end; gap: 5px;">
                    ...
                    <a href="{{url('/vendor/test/create')}}" class="btn btn-blue btn-sm btn-add-data" style="font-weight:600;margin-bottom:5px">
...
@section('js')
    <script>
        ...
        $(document).on('click', '#btn-delete', function () {
            ...
            __swalConfirmation(async (data) => {
                try {
                    ...
                    const res = await fetch(`{{ url('api/vendor/test/delete') }}`, customPost({
        ...
        function searchTerm() {
            ...
            DataTables(__getId('search-datatable').value,  __getId('pelatihan').value, __getId('type_test').value);
        }

        function searchByPelatihan(e) {
            var value = e.target.value;
            console.log(value);
            DataTables(__getId('search-datatable').value, value, __getId('type_test').value);
        }

        function searchByTipe(e) {
            var value = e.target.value;
            // console.log('value = ', value, __getId('pelatihan').value);
            // DataTables(value, __getId('pelatihan').value);
            DataTables(__getId('search-datatable').value, __getId('pelatihan').value, value);
        }
        ...
        function DataTables(searchTerm = '', pelatihan ='', type ='') {
