                ...
                success: function(response) {
                    if (response.status === 'success') {
                        ...
                        if (response.role_id == 1) {
                            window.location.href = '/register/admin/' + response.user_id;
                        } else if (response.role_id == 2) {
                            window.location.href = '/register/vendor/' + response.user_id;
                        } else if (response.role_id == 3) {
                            window.location.href = '/register/employe/' + response.user_id;
                        } else if (response.role_id == 4) {
                            window.location.href = '/register/perusahaan/' + response.user_id;
                        } else {
