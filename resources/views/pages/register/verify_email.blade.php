    ...
    <script>
        ...
        __getId('verifyForm').addEventListener('submit', async function(event) {
            ...
            try {
                ...
                const response = await fetch('/api/register/cek-email', {
                    method: 'POST',
                    headers: {
                ...
                if (result.success) {
                    ...
                    window.location.href = '/register/form-otp/' + user_id;
                    // if (roleId == 1) {
                    //     window.location.href = '/register/admin/' + user_id;
                    // } else if (roleId == 2) {
                    //     window.location.href = '/register/vendor/' + user_id;
                    // } else if (roleId == 4) {
                    //     window.location.href = '/register/perusahaan/' + user_id;
                    // } else {
                    //     // Handle other roles or errors if needed
                    //     emailError.textContent = 'Role tidak valid.';
                    // }
                } else {
