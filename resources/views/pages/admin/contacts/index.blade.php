...
@section('breadcumbTitle', 'Messages')

@section('breadcumbSubtitle', 'Message List')
...
@section('js')
    <script>
        var detailUrl = "{{ url('/pelatihan_saya/detail/') }}";
        ...
        function DataTables(searchTerm = '',) {
            ...
            const ajaxConfig = {
                ...
                ajax: {
                    url: `{{ url('api/contacts/data-table') }}`,
                    dataType: 'JSON',
                    type: 'POST',
                    data: {
