            ...
            <div class="row  d-flex between mb-2">
                <div class="col-md-8">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                          <li class="breadcrumb-item"><a href="{{url('/superadmin/message')}}">Message</a></li>
                          <li class="breadcrumb-item"><span>List Message</span></li>
                        </ol>
                    </nav>
    ...
    <script>
        ...
        function DataTables(searchTerm = '', tanggal = undefined) {
            ...
            var ajaxConfig = {
                ...propertyDB,
                ajax: {
                    url: `{{ url('api/superadmin/message/data-table') }}`,
                    dataType: 'JSON',
                    type: 'POST',
