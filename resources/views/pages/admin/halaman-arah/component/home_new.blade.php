...
<form id="home-form" action="{{url('api/landing-page/home')}}" method="POST" enctype="multipart/form-data"
  ...
  <div id="Section_1" class="mb-3">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <input type="hidden" name="Section_1_id" value="{{$section1['id'] ??en' }}">
            ...
            <div class="mb-2">
              ...
              <div class="form-group">
                <div class="file-upload-container">
                  <input type="file" class="file-input" name="Section_1_photo" id="Section_1_photo" required data-max-file-size="10" accept=".png, .jpeg, .jpg" aria-describedby="Section_1_photo" value="{{ file_exists(public_path('storage/'.$section1['photo'])) ? Storage::url($section1['photo']) : asset($section1['photo']) }}" style="display:none">
     ...
     <div class="col-md-11">
       ...
       <input type="hidden" name="Section_5_Poin_poin_id[{{$item['id']}}]" value="{{$item['id']}}">
         <div class="col-md-12 tests">
           <!-- Judul  input -->
           <div class="mb-2">
             <label for="Section_5_Poin_poin_title1_id[{{$item['id']}}]" class="form-label"> Judul <b>(*)</b>
             </label>
         ...
         <div class="col-md-12 tests">
           <!-- Judul  input -->
           <div class="mb-2">
             <label for="Section_5_Poin_poin_title1_en[{{$item['id']}}]" class="form-label"> Judul <b>(*)</b>
             </label>
         ...
         <div class="col-md-12 tests">
           <!-- Deskripsi  input -->
           <div class="mb-2">
             <label for="Section_5_Poin_poin_description1_id[{{$item['id']}}]" class="form-label"> Deskripsi <b>(*)</b>
             </label>
         ...
         <div class="col-md-12 tests">
           <!-- Deskripsi  input -->
           <div class="mb-2">
             <label for="Section_5_Poin_poin_description1_en[{{$item['id']}}]" class="form-label"> Deskripsi <b>(*)</b>
             </label>
         ...
         <div class="col-md-12 tests">
           ...
           <div class="mb-2">
             ...
             <div class="form-group">
               <div class="file-upload-container">
                 <input type="file" class="file-input" name="Section_5_Poin_poin_photo[{{$item['id']}}]" id="Section_5_Poin_poin_photo[{{$item['id']}}]_{{$item['id']}}" required data-max-file-size="10" value="{{ file_exists(public_path('storage/'.$item['image'])) ? Storage::url($item['image']) : asset($item['image']) }}" accept=".png, .jpeg, .jpg" aria-describedby="Section_5_Poin_poin_photo[{{$item['id']}}]_{{$item['id']}}" style="display:none">
                 <!-- File input is hidden -->
                 <div class="file-upload-box">
                   <div class="file-details">
                     <i class="bi bi-file-earmark"></i>
     ...
     <div class="col-md-11">
       ...
       <input type="hidden" name="Section_5_Poin_poin_id[0]" value="">
         <div class="col-md-12 tests">
           <!-- Judul  input -->
           <div class="mb-2">
             <label for="Section_5_Poin_poin_title1_id[0]" class="form-label"> Judul <b>(*)</b>
             </label>
         ...
         <div class="col-md-12 tests">
           <!-- Judul  input -->
           <div class="mb-2">
             <label for="Section_5_Poin_poin_title1_en[0]" class="form-label"> Judul <b>(*)</b>
             </label>
         ...
         <div class="col-md-12 tests">
           <!-- Deskripsi  input -->
           <div class="mb-2">
             <label for="Section_5_Poin_poin_description1_id[0]" class="form-label"> Deskripsi <b>(*)</b>
             </label>
         ...
         <div class="col-md-12 tests">
           <!-- Deskripsi  input -->
           <div class="mb-2">
             <label for="Section_5_Poin_poin_description1_en[0]" class="form-label"> Deskripsi <b>(*)</b>
             </label>
  ...
  <div id="Section_6_Logo" class="mb-3" style="background:#e9f4ff;padding:1.4rem;border-radius:15px">
    ...
    <div class="row">
      <div class="col-md-11">
        <div class="row dynamic-row">
        <input type="hidden" name="Section_6_id[{{$item['id']}}]" value="{{$item['id'] ?? '' }}">
          <div class="col-md-12 tests">
            <!-- Logo  input -->
            <div class="mb-2">
              ...
              <div class="form-group">
                <div class="file-upload-container">
                  <input type="file" class="file-input" name="Section_6_Logo_logo[{{$item['id']}}]" id="Section_6_Logo_logo[{{$item['id']}}]_{{$item['id']}}" required data-max-file-size="10" value="{{ file_exists(public_path('storage/'.$item['image'])) ? Storage::url($item['image']) : asset($item['image']) }}" accept=".png, .jpeg, .jpg" aria-describedby="Section_6_Logo_logo[{{$item['id']}}]_{{$item['id']}}" style="display:none">
                  <!-- File input is hidden -->
                  <div class="file-upload-box">
                    <div class="file-details">
                      <i class="bi bi-file-earmark"></i>
      ...
      <div class="col-md-12">
        ...
        <input type="hidden" name="Section_7_id" value="{{$section7['id'] ?? '' }}">
          <div class="col-md-12 tests">
            <!-- Judul   input -->
            <div class="mb-2">
              <label for="Section_7_title1_id" class="form-label"> Judul  <b>(*)</b>
              </label>
          ...
          <div class="col-md-12 tests">
            <!-- Deskripsi INDONESIA  input -->
            <div class="mb-2">
              <label for="Section_7_description1_id" class="form-label"> Deskripsi  </label>
          ...
          <div class="col-md-12 tests">
            <!-- Deskripsi ENGLISH  input -->
            <div class="mb-2">
              <label for="Section_7_description1_en" class="form-label"> Deskripsi  </label>
      ...
      <div class="col-md-12">
        ...
        <input type="hidden" name="Section_8_id" value="{{$section8['id'] ?? '' }}">
          ...
          <div class="col-md-12 tests">
            <!-- Tiktok  input -->
            <div class="mb-2">
              <label for="Section_8_tiktok" class="form-label"> Tiktok <b>(*)</b>
              </label>
