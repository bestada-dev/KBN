    ...
    <article class="">
        ...
        <div class="SEARCH">
            <div class="row w-100">
                <div class="col-md-6">
                    <div class="d-flex gap-3 itemscenter">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control form-control-sm" placeholder="Cari Judul Pelatihan" id="search-datatable">
                        </div>
                ...
                <div class="col-md-4">
                    <form>
                        <select class="form-control form-control-sm" id="pelatihan" onchange="searchByPelatihan(event)">
                ...
                <div class="col-md-2">
                    <form>
                        <select class="form-control form-control-sm" id="status" onchange="searchByStatus(event)">
...
@section('js')
    <script>
        var detailUrl = "{{ url('/employe/evaluasi_level_3_employe/detail/') }}";

        function searchTerm() {
            // DataTables(__getId('search-datatable').value);
            DataTables(__getId('search-datatable').value,  __getId('pelatihan').value, __getId('status').value);
        }

        function searchByPelatihan(e) {
            var value = e.target.value;
            console.log(value);
            DataTables(__getId('search-datatable').value, value, __getId('status').value);
        }
        ...
        function DataTables(searchTerm = '', pelatihan ='', status ='') {
            ...
            const ajaxConfig = {
                ...
                ajax: {
                    url: `{{ url('api/employe/evaluasi_level_3_employe/data-table') }}`,
                    dataType: 'JSON',
                    type: 'POST',
                    data: {
