...
@section('js')
    <script>
        var detailUrl = "{{ url('/employe/evaluasi_level_1/detail/') }}";
        var detailUrlAfterFinish = "{{ url('/employe/evaluasi_level_1/detail-after-finish/') }}";
        ...
        function DataTables(searchTerm = '', pelatihan_id = undefined, status_evaluasi = undefined) {
            ...
            const ajaxConfig = {
                ...
                ajax: {
                    url: `{{ url('api/employe/evaluasi_level_1/data-table') }}`,
                    dataType: 'JSON',
                    type: 'POST',
                    data: {
