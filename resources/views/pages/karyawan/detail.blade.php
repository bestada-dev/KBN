...
@section('breadcumbTitle', 'Karyawan Berdasarkan Perusahaan')

@section('breadcumbSubtitle', 'Daftar Karyawan Berdasarkan Perusahaan')
...
@section('content')
    ...
    <article class="">
            ...
            <div class="row w-100">
                <div class="col-md-12">
                    <div class="d-flex gap-3 itemscenter">
                        <a href="{{ url('/superadmin/karyawan') }} ">
        ...
        <input type="hidden" id="getIds" value="{{Request::segment(4)}}">
        <div class="TABLE">
    ...
    <script>
        ...
        function DataTables(searchTerm, categoryId = undefined) {
            ...
            var ajaxConfig = {
                ...propertyDB,
                ajax: {
                    url: `{{ url('api/superadmin/karyawan/data-table-employe-by-company') }}/${$('#getIds').val()}`,
                    dataType: 'JSON',
                    type: 'POST',
