...
@section('js')
    <script>
        var detailUrl = "{{ url('/company/training/detail/') }}";
        ...
        function DataTables(searchTerm = '', categoryId = 'undefined') {
            ...
            const ajaxConfig = {
                ...
                ajax: {
                    url: `{{ url('api/company/training/data-table') }}`,
                    dataType: 'JSON',
                    type: 'POST',
                    data: {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        orderable: false,
                        render: function(data, type, row) {
                            return row.get_pelatihan_dan_pengembangan ? row.get_pelatihan_dan_pengembangan.type : '-';
                        }
                    },
                    {
                        data: null,
