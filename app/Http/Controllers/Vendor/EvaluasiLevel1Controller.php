...
{
    function index(){
        return view('pages.vendor.evaluasi_1.index');
    }
    ...
    function detail($id){
        ...
        return view('pages.vendor.evaluasi_1.detail', [
    ...
    function detailAfterEvaluasi($id){
        ...
        return view('pages.vendor.evaluasi_1.detail_after_evaluasi', [
            'getData' => $data,
        ]);
    }
    ...
    public function dataTable(Request $request)
    {
        try {
            ...
            $data = [];
            $totalData = EmployeTestModel::with(['user', 'getEvaluasiLv1', 'getPelatihan.getVendor'])
            ->whereHas('getPelatihan.getVendor', function ($query) {
            ...
            $query = EmployeTestModel::with(['user', 'getEvaluasiLv1',  'getPelatihan.getVendor']) ->whereHas('getPelatihan.getVendor', function ($query) {
                $query->where('id', Auth::user()->id);
            })->where('status', 'Selesai');
