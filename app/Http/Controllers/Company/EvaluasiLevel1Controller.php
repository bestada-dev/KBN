...
{
    function index(){
        return view('pages.company.evaluasi_1.index');
    }
    ...
    function detail($id){
        ...
        return view('pages.company.evaluasi_1.detail', [
    ...
    function detailAfterEvaluasi($id){
        ...
        return view('pages.company.evaluasi_1.detail_after_evaluasi', [
            'getData' => $data,
        ]);
    }
    ...
    public function dataTable(Request $request)
    {
        try {
            ...
            $data = [];
            $totalData = EmployeTestModel::with(['user', 'getEvaluasiLv1',  'getPelatihan.getVendor']) ->where('created_by', Auth::user()->id)->where('status', 'Selesai')
            ->count();
        
            $totalFiltered = $totalData;
            $posts = '';

            $query = EmployeTestModel::with(['user', 'getEvaluasiLv1',  'getPelatihan.getVendor']) ->where('created_by', Auth::user()->id)->where('status', 'Selesai');
