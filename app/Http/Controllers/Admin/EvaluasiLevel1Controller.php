...
{
    function index() {
        return view('pages.admin.evaluasi_1.index');
    }
    ...
    function detail($id) {
        ...
        return view('pages.admin.evaluasi_1.detail', [
    ...
    function detailAfterEvaluasi($id){
        ...
        return view('pages.admin.evaluasi_1.detail_after_evaluasi', [
            'getData' => $data,
        ]);
    }
    ...
    public function dataTable(Request $request)
    {
        try {
            ...
            $data = [];
            $totalData = EmployeTestModel::with(['user', 'getEvaluasiLv1'])->count();
            $totalFiltered = $totalData;
            $posts = '';

            $query = EmployeTestModel::where('status', 'Selesai')->with(['user', 'getEvaluasiLv1', 'getPelatihan']);
